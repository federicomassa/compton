...
// [2]+[0]/((1+1250*cos(x*(4*atan(1)/180.))/[1])*(1+1250*cos(x*(4*atan(1)/180.))/[1]))    *   (1/(1+1250*cos(x*(4*atan(1)/180.))/[1])+(1+1250*cos(x*(4*atan(1)/180.))/[1])-1+cos(x*(4*atan(1)/180.))*cos(x*(4*atan(1)/180.))
    //1252.85
     TF1* fitfunc = new TF1("Fitting Function", "[0]/((1+[1]*(1-cos((x-[2])*(4*atan(1)/180.))))*(1+[1]*(1-cos((x-[2])*(4*atan(1)/180.)))))*(1/(1+[1]*(1-cos((x-[2])*(4*atan(1)/180.))))+(1+[1]*(1-cos((x-[2])*(4*atan(1)/180.))))-1+cos((x-[2])*(4*atan(1)/180.))*cos((x-[2])*(4*atan(1)/180.)))",-90,90);
     ...
     graph->GetYaxis()->SetTitle("# Coincidenze");
